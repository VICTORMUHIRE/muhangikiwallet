...
urlpatterns = [
    ...
    # ... other URL patterns
    path("transactions/cdf/", views.transactions_cdf, name="transactions_cdf"),
    path("transactions/usd/", views.transactions_usd, name="transactions_usd"),
    ...
    path("opérations/", views.opérations, name="opérations"), # If you have views for this
    path("opérations/creer/", views.creer_opération, name="creer_opération"),
]
