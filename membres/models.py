...
from administrateurs.models import Provinces, Villes, Quartiers, Avenues, TypesCarteIdentite, NumerosCompte, CodesReference, ContributionsMensuelles, TYPES_CARTE_IDENTITE
